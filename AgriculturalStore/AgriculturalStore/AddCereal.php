<?php 
    ...
    if(isset($_POST['submit'])){
        $VegetableType= $_POST['CerealType'];
        ...
        $res=false;
        $insert_query="INSERT INTO `cereals`(`CerealType`, `Quantity`, `Price`, `ItemPhoto`) VALUES ($CerealType','$Quantity','$Price')";
...
<div class="container"> 
     <div class="row">
        ...
        <div class="page-header">
            <h1 style="text-align: center;">Add a Cereal </h1>
            <?php echo $msg; ?>
      </div> 
       <div class="col-md-3">
       </div>
        <div class="col-md-6 animated bounceIn"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group">
                  <span class="input-group-addon"><b>CerealType</b></span>
                  <input id="CerealType" type="text" class="form-control" name="CerealType" placeholder="CerealType" required>
                </div>
                <br>
                 <div class="input-group">
